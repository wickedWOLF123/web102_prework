...
const unfundedText = numberOfUnfundedGames === 1 ? 'game remains unfunded' : 'games remain unfunded';

const summaryText = `
    A total of $${totalRaised.toLocaleString()} has been raised across ${totalGames} ${totalGames === 1 ? 'game' : 'games'}. 
    ${numberOfUnfundedGames} ${unfundedText}.
`;


// create a new DOM element containing the template string and append it to the description container
const descriptionParagraph = document.createElement('p');
descriptionParagraph.innerHTML = summaryText;
